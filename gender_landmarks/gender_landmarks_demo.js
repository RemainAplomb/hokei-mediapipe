...
var camera_util_1 = require("./camera_util");
//Video element
...
//Container element
exports.VideoPlayer = document.createElement('div');
exports.VideoPlayer.appendChild(videoSource);
exports.VideoPlayer.appendChild(canvasOutput);
exports.VideoPlayer.style.position = 'relative';
exports.VideoPlayer.style.margin = '0';
exports.VideoPlayer.style.padding = '0';
(_a = document.getElementById('container')) === null || _a === void 0 ? void 0 : _a.appendChild(exports.VideoPlayer);
// The solution is already connected to the video, we just need to use
// the camera to drive it.
var camera = new camera_util_1.Camera(videoSource, {
