...
class InferenceCalculator : public NodeIntf {
 public:
  ...
  static constexpr SideInput<tflite::ops::builtin::BuiltinOpResolver>::Optional kSideInCustomOpResolver{"CUSTOM_OP_RESOLVER"};
  ...
  MEDIAPIPE_NODE_CONTRACT(kInTensors, kSideInCustomOpResolver, kSideInModel, kOutTensors, kDelegate);
